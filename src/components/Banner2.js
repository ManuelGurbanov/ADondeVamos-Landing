    ...
    <>
      <section className="relative flex-row items-center justify-center px-8 mx-auto mt-5 text-left max-w-7xl lg:px-8" >
        ...
        <div className="flex-row items-start justify-start mt-7 mb-7">
          <button className="p-2 m-5 transition duration-75 bg-instagram-gradient rounded-2xl hover:scale-105">
          ...
          <button className="p-2 m-5 transition duration-75 ring-1 ring-inset ring-blue-300 bg-zinc-900 rounded-2xl hover:scale-105">
